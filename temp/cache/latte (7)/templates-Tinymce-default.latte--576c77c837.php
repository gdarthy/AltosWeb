...
?>
		...
		echo end($this->global->formsStack)["title"]->getControl()->addAttributes(['class'=>'title', 'id'=>'logTitle', 'rows'=>1]) /* line 16 */ ?>

        </div>
        <div class="form-group">
            <?php if ($_label = end($this->global->formsStack)["labelPreamble"]->getLabel()) echo $_label->addAttributes(['for'=>'logPreamble']) ?>            <?php
		echo end($this->global->formsStack)["preamble"]->getControl()->addAttributes(['class'=>'form-control', 'id'=>'logPreamble']) /* line 20 */ ?>

        </div>
        <?php echo end($this->global->formsStack)["tinymce"]->getControl()->addAttributes(['class'=>'tinymce']) /* line 22 */ ?>

        <div class="send-button">
            <?php echo end($this->global->formsStack)["btnSend"]->getControl()->addAttributes(['class'=>'btn btn-default']) /* line 24 */ ?>
