...
?><div class="log">
    ...
    <div class="date">
        <span class="glyphicon glyphicon-calendar"></span><?php echo LR\Filters::escapeHtmlText(call_user_func($this->filters->date, $log['date'], '%d.%m.%Y')) /* line 12 */ ?>

        <span class="glyphicon glyphicon-comment"></span>
        <span class="disqus-comment-count" data-disqus-identifier="<?php echo LR\Filters::escapeHtmlAttr($log['logid']) /* line 14 */ ?>"></span>
    </div>
    <div class="log-preamble">
        <?php echo $log['preamble'] /* line 17 */ ?>
