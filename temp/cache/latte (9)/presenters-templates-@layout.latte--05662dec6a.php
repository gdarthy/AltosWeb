...
?>
        ...
        <div class="row">
            ...
            <div class="container-fluid footer-area">
                <p class="text-muted text-center footer-text">Webdesign <a class="login" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Login:default")) ?>">BugFactory</a> &copy;2017</p>
            </div>
        </div>
<?php
