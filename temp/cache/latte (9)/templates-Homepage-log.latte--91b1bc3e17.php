...
<div class="log">
    ...
    <div class="date">
        <span class="glyphicon glyphicon-calendar"></span><?php echo LR\Filters::escapeHtmlText(call_user_func($this->filters->date, $devlog['date'], '%d.%m.%Y')) /* line 10 */ ?>

    </div>
    <?php echo $devlog['content'] /* line 12 */ ?>
...
<div class ="log">
    ...
    <script>
        var disqus_config = function () {
            ...
            this.page.identifier = <?php echo LR\Filters::escapeJs($devlog['logid']) /* line 19 */ ?>; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
        };
